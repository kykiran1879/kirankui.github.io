...
# Partial F test to see if temperature is significant
anova(base, fit)

# Store the fitted values for the interaction model
...
ggplot(kestrel_july_df) +
  ...
  labs(
    ...
    y = "Temperature (F)",     
    color = "Day",                    
    title = "Temperature vs. Relative Humidity by Day in July"  # Added title
  )
